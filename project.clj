(defproject 
  director-musices "3.1.4"
  :description "FIXME: write description"
  ;:manifest ["SplashScreen-Image" "splash.gif"] ;did not work for uberjar
  :dependencies [[org.clojure/clojure "1.10.1"];[org.clojure/clojure "1.5.0"]
                 ...
                 [org.clojure/tools.cli "1.0.194"]; [org.clojure/tools.cli "0.2.2"]
  ...
  :profiles {:dev {:dependencies [[org.clojure/tools.namespace "1.0.0"] ;[org.clojure/tools.namespace "0.2.2"]
                                  ]}
